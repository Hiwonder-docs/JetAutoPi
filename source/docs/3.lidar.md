...
(1) Start the robot, and connect it to NoMachine according to the instructions provided in [Quick Start Guide(JetAuto User Manual) ->1.6 Development Environment Setup and Configuration]().
...
For instructions on app connection, please consult the tutorial located in [1.Quick Start Guide(JetAuto User Manual)->1.5 APP Control]()
...
For instructions on app connection, please consult the tutorial located in [1.Quick Start Guide(JetAuto User Manual)->1.5 APP Control]()Start the robot, and access the robot system desktop using VNC.
