...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image36.png"  />
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image41.png"  />
...
<table  class="docutils-nobg" style="margin:0 auto" border="1" width="500px" >
<colgroup>
<col  />
<col  />
</colgroup>
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image47.png"  />
...
For exploring its functionality and view the program, you need to connect to the robot's system through the remote connection tool, please refer to the subsequent content under "6. Development Environment Setup".
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image51.png" width="650px" />
...
<td >After turning on the robot, say "Hello, Hiwonder".</td>
<td >The robot responds "I' m here". (the voice function is only targeted for the user who purchased advanced kit and ultimate kit.)</td>
</tr>
<tr>
<td >Depth camera + robotic arm</td>
<td >(1) Connect to the robot via app.<br>
(2) Open "Robot Control" to view the live camera feed from the depth camera.<br>
...
<td >After robot powers on, perform the "Robot control" function on app using the wireless handle or mobile phone to check the hardware functions.</td>
...
If you purchased the robot kit without Jetson or Raspberry Pi board, please first go through the content from "[1.6 Development Environment Setup]()" to "[1.6.7 Robot Version Configuration Tool Instructions]()".
...
If you want to connect robot under LAN modem, please refer to "[1.5.1 Preparation -> LAN Mode Connection (Optional)]()".
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image72.png" width="500px " />
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image69.png" width="500px" />
...
⑩ You can search for its IP address through the remote connection tool and establish a connection. For detailed instructions, please refer to "[1.6 Development Environment Setup and Configuration]()".
...
|:--:|:--:|:--:|
| <img class="common_img" src="../_static/media/chapter_1/section_1/media/image83.png"  /> | Robot Control | Control the movement of the robot. |
| <img class="common_img" src="../_static/media/chapter_1/section_1/media/image84.png"  /> | Lidar | There are three lidar functions, including avoid obstacle, lidar following and lidar guarding. |
| <img class="common_img" src="../_static/media/chapter_1/section_1/media/image85.png"  /> | Object Tracking | Select the color for the target, allowing the robot to track the target. |
| <img class="common_img" src="../_static/media/chapter_1/section_1/media/image86.png"  /> | Line Following | Pave the line, choose the line color as the recognizable color and the robot will move along the line. |
| <img class="common_img" src="../_static/media/chapter_1/section_1/media/image87.png"  /> | Gesture Control | Through recognizing the movement trajectory of the palm, the robot's movement state can be controlled, including forward and backward,left and right turns, and left and right translates (available only in the mecanum wheel chassis configuration) |
| <img class="common_img" src="../_static/media/chapter_1/section_1/media/image88.png"  /> | AR | The tag can display the set 3D image within the live camera feed. |
...
If you are unsure the IP address, please refer to "[1.5.1 Preparation -> LAN Mode Connection (Optional)]()".
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image133.png" width="895px" />
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image148.png"  />
...
(12) Enter the obtained IP address into NoMachine to establish a remote connection. For detailed instructions, please refer to the tutorial "[1.6.2 AP Direct Connection Mode]()."
...
Jetson Orin Nano version only has the command-line terminal for ROS2 environment. <img class="common_img" src="../_static/media/chapter_1/section_1/media/image169.png"   />

* **Jetson Orin NX Version**

Jetson Orin NX version only has the command-line terminal for ROS2 environment. <img class="common_img" src="../_static/media/chapter_1/section_1/media/image169.png"   />
...
(2) Click on the screen desktop. Open <img class="common_img" src="../_static/media/chapter_1/section_1/media/image187.png"  />
...
(7) After the mapping is complete, if you want to close this function, click interface and tap<img class="common_img" src="../_static/media/chapter_1/section_1/media/image194.png"  />.
...
(8) After the mapping is complete, if you want to close this function, click interface and tap<img class="common_img" src="../_static/media/chapter_1/section_1/media/image199.png"  />.
...
* If you want to learn about how to save multiple maps, please delve into the content in "[1.9 Autonomous Navigation]()" .
...
(4) <img class="common_img" src="../_static/media/chapter_1/section_1/media/image207.png"  />changes the initial position of the robot on the map and mark the robot's actual position.
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image229.png"  /><img class="common_img" src="../_static/media/chapter_1/section_1/media/image230.png"  />
...
<p style="margin:0 auto 24px;width:100%">
<img src="../_static/media/chapter_1/section_1/media/image242.png" style="width:46%" />
<img src="../_static/media/chapter_1/section_1/media/image243.jpeg"  style="width:46%" />
</p>
...
<p style="margin:0 auto 24px;width:100%">
<img src="../_static/media/chapter_1/section_1/media/image49.png" style="width:48%" width="350px" />
<img src="../_static/media/chapter_1/section_1/media/image50.png" style="width:48%" width="350px" />
</p>
Lidar A1 Lidar G4
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image250.png"  />

The handle receiver is connected to the position highlighted in the below red box:

<img class="common_img" src="../_static/media/chapter_1/section_1/media/image251.png"  />
...
Before starting this section, you need to use Nomachine remote desktop connection software. For detailed instructions, please refer to "1.6.1 Remote Connection Tool Introdiction & Installation".
...
(1) Click<img class="common_img" src="../_static/media/chapter_1/section_1/media/image252.png"  />to open the command terminal. Enter the below command, and then press Enter to view each file under the home directory.
...
| **<span class="mark">Directory name</span>** | **<span class="mark">Function</span>** |
|:--:|:--:|
...
① Click-on <img class="common_img" src="../_static/media/chapter_1/section_1/media/image259.png"  /> to initiate ROS2 command-line terminal. Then input the following command to check the content contained in the directory.
...
| **<span class="mark">File Name</span>** | **<span class="mark">Function</span>** |
|:--:|:--:|
| <span class="mark">noetic_ws</span> | Workspace for bridging with ROS1 |
| <span class="mark">ros2_ws</span> | Workspace for ROS2 functional play |
| <span class="mark">share</span> | Directory shared with the main system（/home/hiwonder/docker/tmp） |
| <span class="mark">third_party_ros2</span> | Relevant third-party software libraries |
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image269.png"  />
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image275.png"  />
...
<img class="common_img" src="../_static/media/chapter_1/section_1/media/image284.png"  /><img class="common_img" src="../_static/media/chapter_1/section_1/media/image285.png"  />
